...
import { UiEmojiBase } from "@discord-ui-kit/core";

export class CustomEmojis extends UiEmojiBase {
...
But now we can't access it at all! We can use a getter method to be able to grab our token and use it for whatever though!
...
Let's override the check mark emoji!
